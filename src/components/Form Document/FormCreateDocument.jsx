...
function FormCreateDocument({documentCreate}) {
    ...
    const store = (e) => {
        ...
        const sufijo = Math.floor(Math.random() * 100).toString();
        //dígito calculado con el algoritmo de Luhn3 utilizando como entrada la secuencia de dígitos conformada por los literales a), b) y c).
